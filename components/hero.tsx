...
const Hero = () => {
  ...
  return (
      <motion.div
        className="text-start flex justify-center items-start flex-col min-h-[60dvh] z-50 md:px-24 px-4 max-w-[900px] text-pretty gap-4"
        initial="initial"
        animate="animate"
        variants={stagger}
      >
        ...
        <motion.p className="text-xl text-muted-foreground" variants={fadeIn}>
          ...
          applications. Packed with beautiful components and templates to help
          you build faster
        </motion.p>
        <motion.div
          variants={fadeIn}
